...
//                PluginManager.INSTANCE.loadApk(this, hotFixFile.absolutePath, "com.coding.other")
...
//
//    fun startApk() {
//        PluginManager.INSTANCE.startActivity(this@MainActivity, "com.coding.other.Main1Activity")
